...
\node[title] at (0.05,1.66) {生成器 $G_v$};

\io{0.45}{0.32}{0.22}{0.94}{$6$}{gin}{ginout}
\node[detaillabel] at (0.57,-0.76) {$[\boldsymbol{v}_{\rm ZA},\boldsymbol{\Psi}_{\rm final}]$};
...
\node[detaillabel] at (16.05,-0.72) {$\Delta\boldsymbol{v}$};

\stage{0.54}{1.03}{$6$}{-0.50}{$24^3$}
...
\node[title] at (0.05,-6.18) {多尺度判别器 $D_v$};
\io{0.65}{-7.95}{0.24}{0.94}{$9$}{din}{dinout}
\node[detaillabel, minimum width=2.00cm] at (1.05,-7.82)
  {$[\boldsymbol{v}_{\rm ZA},\boldsymbol{\Psi}_{\rm final},\Delta\boldsymbol{v}]$};
\stage{0.77}{-7.20}{$9$}{-8.52}{$24^3$}
\coordinate (split) at (2.45,-7.72);
\draw[flow] (dinout) -- (split);

\block{3.25}{-7.28}{0.28}{0.74}{purple!15}{purple!60!black}{$64$}{df1}{df1out}
\block{3.85}{-7.28}{0.36}{0.58}{purple!15}{purple!60!black}{$128$}{df2}{df2out}
\outblk{4.55}{-7.28}{0.20}{0.58}{$1$}{df3}{df3out}
\stage{4.06}{-6.50}{$64,128,1$}{-7.80}{$12^3,6^3,6^3$}
\draw[flow] (split) |- (df1);
\draw[flow] (df1out) -- (df2);
\draw[flow] (df2out) -- (df3);

\block{3.25}{-8.70}{0.28}{0.74}{purple!15}{purple!60!black}{$64$}{dc1}{dc1out}
\block{3.85}{-8.70}{0.36}{0.58}{purple!15}{purple!60!black}{$128$}{dc2}{dc2out}
\block{4.55}{-8.70}{0.48}{0.46}{purple!15}{purple!60!black}{$256$}{dc3}{dc3out}
\outblk{5.40}{-8.70}{0.20}{0.46}{$1$}{dc4}{dc4out}
\stage{4.48}{-7.90}{$64,128,256,1$}{-9.29}{$12^3,6^3,3^3,3^3$}
\draw[flow] (split) |- (dc1);
\draw[flow] (dc1out) -- (dc2);
\draw[flow] (dc2out) -- (dc3);
\draw[flow] (dc3out) -- (dc4);

\node[align=left, anchor=west] at (6.55,-7.30) {细分支：2 个步长为 2 的判别卷积块};
\node[align=left, anchor=west] at (6.55,-8.73) {粗分支：3 个步长为 2 的判别卷积块};
